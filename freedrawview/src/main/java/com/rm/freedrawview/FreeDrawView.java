...
public class FreeDrawView extends View implements View.OnTouchListener {
    ...
    public void restoreStateFromSerializable(FreeDrawSerializableState state) {
        ...
        if (state != null && mLastDimensionW > 0 && mLastDimensionH > 0) {
    ...
    public void restoreStateFromSerializableResize(FreeDrawSerializableState state) {
        ...
        if (state != null && mLastDimensionW > 0 && mLastDimensionH > 0) {
            ...
            int oldLastDimensionW = -1, oldLastDimensionH = -1;

            if (state.getLastDimensionW() >= 0) {
                oldLastDimensionW = state.getLastDimensionW();
            }

            if (state.getLastDimensionH() >= 0) {
                oldLastDimensionH = state.getLastDimensionH();
            }

            resize((float)mLastDimensionW / oldLastDimensionW, (float)mLastDimensionH / oldLastDimensionH);
            state.setLastDimensionW(mLastDimensionW);
            state.setLastDimensionH(mLastDimensionH);
    ...
    public void resize(float xMultiplyFactor, float yMultiplyFactor) {
        // Adapt drawn paths
